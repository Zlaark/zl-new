                        ...
                        >
                            ...
                            <div className='absolute inset-0 p-8 flex flex-col justify-between'>
                                <div className='flex justify-end'>
                                    <div className='w-12 h-12 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center text-white border border-black/5 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500'>
                                        <ArrowUpRight size={24} />
                                    </div>
                                </div>

                                <div className='transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500'>
                                    <div className='inline-block py-1 px-3 rounded-full bg-white/10 backdrop-blur-md border border-black/5 text-white/80 text-xs font-medium tracking-wide mb-4'>
                                        {project.category}
                                    </div>
